...
$ens = $data_pfe['enseignant'];
$etu1 = $data_pfe['etudiant1'];
$etu2 = $data_pfe['etudiant2'];

$pfe1= $bdd->prepare("SELECT * FROM `enseignant` WHERE emailusthb = '$ens' ");
$pfe1->execute();
$data_ens = $pfe1->fetch();
...
<div class="sidebar">
        <div class="logo_content">
            <div class="logo">
                ...
                <div class="logo_name"> Soutenance</div>
            </div>
    ...
    <div class="home_content">
        <div class="col-md-12">
            <div aria-label="breadcrumb" class=" main-breadcrumb">
                <h4 class="text">Accord de soutenance Licence</h4>
                <ol class="breadcrumb">
                    <li class="active">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-8">
                                <div class='input-group date'>
                                    <input name="Dateautorisation" type="text" id="updatedDate" class="datepicker" placeholder="Séléctionnez une date" name="updatedDate" data-date-format="dd/mm/yyyy" required />
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input name="commission" disabled value="" id="comi" type="text" class="form-control form-control-line" >
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea rows="4" disabled value="" name ="Organisme" class="form-control form-control-line"><?php echo "USTHB" ?> </textarea>
                        </div>
                        <div class="form-group col-md-12">
                            <hr class="my-4">
                        ...
                        <div class="form-group col-md-7">
                            ...
                            <div class="col-sm-12">
                                <input disabled value="<?php echo $data_ens['nom']." ".$data_ens ['prenom'];?>" name ="Promoteur1" id="num" type="text" placeholder="Nom et prénom du promoteur" class="form-control form-control-line">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <li>
                                    ...
                                    <input type="checkbox" name="biblio" value="" id="flexCheckDefault">
                                </li>
                            ...
                            <div class="col-sm-12">
                                <li>
                                    ...
                                    <input type="checkbox" name="conception" value="" id="flexCheckDefault">
                                </li>
                            ...
                            <div class="col-sm-12">
                                <li>
                                    ...
                                    <input type="checkbox" name="document" value="" id="flexCheckDefault">
                                </li>
                            ...
                            <div class="col-sm-12">
                                <li>
                                    ...
                                    <input type="text" name="realisation" placeholder="80% min" style="margin-left: 20px; size: 2px;">
                                </li><br>
                            ...
                            <div class="col-sm-12">
                                <li>
                                    ...
                                    <textarea rows="5" name="autre" class="form-control form-control-line"></textarea>
                                </li>
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-12">
                                    <li>
                                        ...
                                        <textarea rows="15" name="motif" class="form-control form-control-line"></textarea>
                                    </li>
                                </div>
                        ...
                        <div class="form-group col-md-7">
                            ...
                            <div class="col-sm-12">
                                <input disabled value="" id="num" type="text" placeholder="Nom et prénom du membre" class="form-control form-control-line">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-sm-12">
                                <li>
                                    ...
                                    <textarea  disabled value="" rows="5" class="form-control form-control-line"></textarea>
                                </li>
                        ...
                        <div class="col-sm-12">
                            <hr>
                            <input name="visibilité" type="checkbox" value="" id="flexCheckDefault">
                            <label id="lab" style="color: green;">Si vous cochez cette case, une copie de cet accord sera envoyé aux étudiants concernés par ce projet</label>
                            <br>
                        </div>
