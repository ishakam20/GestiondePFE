...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		...
		<hr>
		<div class="col-12">
			<p class = "lead">Ce site Web est une platforme dédiée aux étudiants et enseignants de l'université des sciences et de la technologie Houari Boumediene. Dans le but de faciliter la gestion et  permettre la planification et le bon suivi des projets de fin d'étude des deux sycles License et Master.  </p>
		</div>
	</div>
</div>
...
<div class ="container-fluid padding">
	<div class ="row text-center padding">
		...
		<div class =" col-sm-12 col-md-4">
			...
			<h3>Gestion Sure</h3>
			<p>Une gestion facile et fluide des projets de fin d'études et des soutenances pour l'administration.</p>
