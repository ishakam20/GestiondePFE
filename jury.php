...
$jury = $bdd->prepare("SELECT * FROM soutenance_jury WHERE president = '$emailusthb' OR membre = '$emailusthb' ");
$jury->execute();
    ...
    <div class="home_content">
        <div class="col-md-12">
            <div aria-label="breadcrumb" class=" main-breadcrumb">
                <h4 class="text">Jury</h4>
                <ol class="breadcrumb">
                    <li class="active">
                        <a href="#"></a>Tous les projets </li>
                </ol>
            </div>
            <div class="row">
                <div class="col-sm-12">
...
?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php if($d['membre']===$emailusthb){ echo "membre";
                                    }elseif($d['president']===$emailusthb)
                                    {echo "president" ; }?>
                                    </td>
                                    <td>
                                        <div class="modif">
                                    ...
                                    <td>
                                        <div class="modif">
                                            <a href="inv.php?d=<?=$id?>"><button class="btn btn-outline-dark" id="mod">Convocation</button></a>                                            
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
