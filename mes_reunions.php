...
session_start();              //ouverture de la séance.
    ...
    $reunion = $bdd->prepare('SELECT * FROM reunion WHERE organisateur = ? ');
    ...
    <div class="home_content">
        <div class="col-md-12">
            <div aria-label="breadcrumb" class=" main-breadcrumb">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <a href="mes_reunions.php"></a>Réunions planifiées | </li>
                    <li><a href="mes_demandes_reunions.php">Demandes de réunions |</a></li>
