...
{
$id=$_GET['d'];
$jury = $bdd->prepare("SELECT * FROM `convocation-soutenance` WHERE mail_rec = '$emailusthb' AND id_projet = '$id' ");
$jury->execute();
    ...
    <div class="home_content">
        <div class="col-md-12">
            <div aria-label="breadcrumb" class=" main-breadcrumb">
                <h4 class="text">Mes Convocations</h4>
                <ol class="breadcrumb">
                    <li class="active">
                        <a href="prof.html"></a>Convocation |</li>
                    <li>
                    <li >
                        <a href="convo_promoteur.php">Mes Convocations</a>  </li>
                    <li>
                </ol>
            </div>
        </div>
        <div class="container justify-content-center">
            <div class="card">
                ...
                <div class="back">
                    ...
                    <br>
                    <p> Nous avons l'honneur de vous présenter cette convocation pour vous cpmmuniquer les informations de la soutenance concernant le projet dont l'intitulé est indiqué ci-dessus </p>
