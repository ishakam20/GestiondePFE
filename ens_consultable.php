...
if (isset($nom) && isset($prénom) && isset($type)) {
  $email = ($_SESSION['user']);
  $profile = $bdd->prepare("SELECT * FROM enseignant WHERE email = '$prénom.$nom@usthb.dz'");
  $profile->execute();
                    ...
                    <div class="card-body" id="extra-info">
                        <div class="row ">
                            ...
                            <div class="group col-md-6">
                                ...
                                <div class="col-md-12">
                                    <input type="text"  disabled value=" <?php echo $data_profile['numerotel'] ; ?>" placeholder="Entrez votre numero" value= <?php echo "Vous n'avez pas accés à cette information" ; ?> class="form-control form-control-line"> </div>
                            </div>
