    ...
    <div class="home_content">
        <div class="col-md-12">
            <div aria-label="breadcrumb" class=" main-breadcrumb">
                ...
                <ol class="breadcrumb">
                    <li class="active"><a href="proposer.php"></a>Proposer pour Licence | </li>
                    <li><a href="proposer_master.php">Poposer pour Master  </a></li>
                </ol>
            </div>
        </div>
        <?php 
        if(isset( $_GET['depot']) && $_GET['depot']==='oui')
            {
            echo "<div class=\"alert alert-success\" role=\"alert\">  Le PFE a bien été publié!</div>";
            }elseif(isset( $_GET['depot']) && $_GET['depot']==='non') {
                echo "<div class=\"alert alert-danger\" role=\"alert\">  Le PFE n'a pas été publié!</div>";
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="ISIL" id="flexCheckChecked" name="spec[]" >
                                    <label  class="form-check-label" for="flexCheckChecked">
                                        ISIL
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="GTR" id="flexCheckChecked" name="spec[]">
                                    <label class="form-check-label" for="flexCheckChecked">
                                        GTR
                                    </label>
                                </div>
