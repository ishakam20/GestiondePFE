...
<html lang="fr">
<head>
<title _msthash="149916" _msttexthash="91234" _msthidden="1">Login V15</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
                ...
                ?>
					<div class="wrap-input100 validate-input" data-validate = "emailusthb">
						<input class="input100" type="emailusthb" name="emailusthb" placeholder="@usthb.dz">
